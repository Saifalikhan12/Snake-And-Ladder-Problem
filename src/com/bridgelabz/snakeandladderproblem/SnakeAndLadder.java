...
public class SnakeAndLadder {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Snake and Ladder Simulator Problem Developed.");

        //Creating Object for Player
        com.bridgelabz.snakeandladderproblem.SnakeAndLadder player1 = new com.bridgelabz.snakeandladderproblem.SnakeAndLadder();
